...
function index() {
  return (
    <div className="md:max-w-[1130px] relative m-auto">
      <section className="container m-auto px-6 ">
        <div className="text-center">
          <p className=" text-lg text-[#9666FF] pt-12 w-full">
            Our products
          </p>
          <div className=" pl-24  flex flex-col items-center justify-center m-auto max-w-[500px]  top-6">
            <svg
              width="192"
              height="35"
              viewBox="0 0 192 35"
        ...
        <div className="container m-auto text-center mb-6">
        ...
        <div className=" space-y-5">
          ...
          <div className="flex gap-4 items-center justify-center md:flex-row flex-col space-y-6">
            ...
            <div className=" bg-[url('../assets/grainTexture.png')] bg-[#FFADD2] bg-blend-overlay flex flex-col items-center justify-between container md:m-auto  rounded-3xl">
              <div className=" space-y-6 pt-8 px-6">
                <h1 className="text-[#2A0079] md:text-3xl text-2xl font-bold max-w-[400px] px-6 ">
          ...
          <div className="flex gap-4 items-center justify-center md:flex-row flex-col space-y-6">
            ...
            <div className=" bg-[url('../assets/grainTexture.png')] bg-[#B1EDFB] bg-blend-overlay flex flex-col items-center justify-between container md:m-auto  rounded-3xl">
              <div className=" space-y-6 pt-8 px-6">
          ...
          <div className=" bg-[url('../assets/grainTexture.png')] bg-[#FECCAE] bg-blend-overlay flex items-center md:flex-row flex-col justify-between md:m-auto container  rounded-3xl p-6">
            <div className="md:w-1/2 space-y-3 p-6">
              ...
              <p className="text-[#302D53] leading-7">
                ...
                charges by using a unique tag generated within the app. Enjoy
                the convenience and cost-saving benefits of this feature with
                Aza.
              </p>
            </div>
